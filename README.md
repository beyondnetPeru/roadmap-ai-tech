...
| Lab | Description                                                                                       | Directory                                         |
| --- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| 1   | Runnable TypeScript examples for Phase 1: structured outputs, function calling, and Vercel AI SDK | [Open `src/handson-1` →](src/handson-1/README.md) |
